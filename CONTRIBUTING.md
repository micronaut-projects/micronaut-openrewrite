...
Sign the [Contributor License Agreement (CLA)](https://cla-assistant.io/micronaut-projects/micronaut-openrewrite). This is required before any of your code or pull-requests are accepted.
...
Micronaut openrewrite currently requires JDK 17.

## IDE Setup

Micronaut openrewrite can be imported into IntelliJ IDEA by opening the `build.gradle` file.

## Docker Setup

Micronaut openrewrite tests currently require Docker to be installed.
